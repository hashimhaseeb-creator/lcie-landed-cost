  ...
  return (
    <Card className="border-emerald-200/60 dark:border-emerald-900/40 relative overflow-hidden before:absolute before:left-0 before:top-0 before:h-full before:w-1 before:bg-emerald-500">
      <CardHeader className="pb-2 pl-5">
        ...
        <CardDescription className="pl-5">{calc.region === 'US' ? 'Duty on FOB · 9903.88.x China 10% (held per Nov 10 2025 deal) + 9903.01.24 Fentanyl IEEPA 10% (reduced Nov 10 2025) + 9903.01.25 any-country 10% baseline · MPF' + (calc.hmfApplies ? ' + HMF' : ' (no HMF)') + ' · no federal VAT' : calc.region === 'AU' ? 'Duty on CIF (General rate, often FREE) · GST 10% on (CIF + duty) · Import Processing Charge A$50 (flat)' : 'Duty on CIF · VAT on (CIF + duty)'}</CardDescription>
      </CardHeader>
